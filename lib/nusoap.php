...
class wsdl extends nusoap_base {
    ...
    */
    function webDescription(){
		...
		$b = '
		<html><head><title>iPX Server : Celuavisos</title>
		<style type="text/css">
		    body    { font-family: arial; color: #000000; background-color: #ffffff; margin: 0px 0px 0px 0px; }
		    p       { font-family: arial; color: #ffffff; margin-top: 0px; margin-bottom: 12px; }
		    ...
		    .nav {
			padding-top: 10px; padding-bottom: 10px; padding-left: 15px; font-size: 16px;
			margin-top: 10px; margin-left: 0px; color: #000000;
			background-color: #E37329; width: 25%; margin-left: 20px; margin-top: 20px; }
		    .title {
			font-family: arial; font-size: 26px; color: #ffffff;
			background-color: #404040; width: 100%;
			margin-left: 0px; margin-right: 0px;
			padding-top: 15px; padding-bottom: 15px; padding-left: 18px;}

			.title2 {
			font-family: arial; font-size: 12px; color: #ffffff;}
		    .hidden {
			position: absolute; visibility: hidden; z-index: 200; left: 380px; top: 81px;
			font-family: arial; overflow: hidden; width: 500;
			padding: 20px; font-size: 16px; background-color: #999999;
			layer-background-color:#FFFFFF; }
		    a,a:active  { color: charcoal; font-weight: bold; }
		    a:visited   { color: #404040; font-weight: bold; }
		...
		<body>
		<div class=content>
			<div class=title>Servicio Web SOAP - Celuavisos <div class=title2>v1.5.0</div> </div> 
			<div class=nav>
				<p><a href="'.$PHP_SELF.'?wsdl">WSDL</a> para ver la descripción del Servicio Web.<br><br>
				Más detalles de los servicios.</p>
				<ul>';
				foreach($this->getOperations() as $op => $data){
				    $b .= "<li><a href='#' onclick=\"popout();popup('$op')\">$op</a></li>";
				    // create hidden div
				    $b .= "<div id='$op' class='hidden'>
				    <a href='#' onclick='popout()'><font color='#ffffff'>Cerrar</font></a><br><br>";
